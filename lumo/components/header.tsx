...
export function Header() {
  ...
  return (
    <div className="w-full fixed top-0 z-50 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 border-b border-border/40">
      ...
      <header className="relative max-w-6xl mx-auto px-4">
        <div className="flex h-16 items-center justify-between">
          ...
          >
            <HeartPulse className="h-7 w-7 text-primary animate-pulse-gentle" />
